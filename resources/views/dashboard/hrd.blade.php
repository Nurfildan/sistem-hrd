...
<head>
    ...
    <title>HRD Dashboard - Sistem Kepegawaian</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div>
                            ...
                            <p class="text-muted mb-0">Kelola data kepegawaian dengan mudah</p>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $karyawanAktif }}</div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $absensiHariIni }}</div>
                                            <small class="text-muted">dari {{ $karyawanAktif }} karyawan</small>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $totalGajiDiproses }}</div>
                                            <small class="text-muted">dari {{ $karyawanAktif }} karyawan</small>
                                        </div>
                                        <div class="col-auto">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <span class="d-block font-weight-bold">{{ $cuti->karyawan->nama ?? 'N/A' }}</span>
                                                                <small class="text-muted">{{ $cuti->karyawan->departemen->nama_departemen ?? '-' }}</small>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        @if($cuti->status == 'Menunggu')
                                                            <a href="{{ route('cuti.show', $cuti->id) }}" class="btn btn-sm btn-primary">Review</a>
                                                        @else
                                                            <a href="{{ route('cuti.show', $cuti->id) }}" class="btn btn-sm btn-secondary">Detail</a>
                                                        @endif
                                                    </td>
                                                </tr>
                                                @empty
                                                <tr>
                                                    <td colspan="4" class="text-center text-muted py-3">Belum ada pengajuan cuti</td>
                                                </tr>
                                                @endforelse
                                            </tbody>
                                        </table>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="progress" style="height: 8px;">
                                            @php
                                                $percentage = $karyawanAktif > 0 ? ($dept->karyawan_count / $karyawanAktif) * 100 : 0;
                                            @endphp
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-4">
                            <div class="card shadow-sm border-0">
                                ...
                                <div class="card-body">
                                    <a href="{{ route('karyawan.create') }}" class="btn btn-primary btn-block mb-2">
                                        <i class="fas fa-user-plus mr-2"></i> Tambah Karyawan Baru
                                    </a>
                                    <a href="{{ route('absensi.index') }}" class="btn btn-success btn-block mb-2">
                                        <i class="fas fa-clock mr-2"></i> Kelola Absensi
                                    </a>                                    
                                    <a href="{{ route('karyawan_shift.index') }}" class="btn btn-warning btn-block">
                                        <i class="fas fa-calendar mr-2"></i> Atur Jadwal Shift
                                    </a>
                                </div>
                            </div>
                        </div>
