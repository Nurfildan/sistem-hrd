                            ...
                            @if($todayAbsen)
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-3">
                                        ...
                                        <span
                                            class="badge badge-{{ $todayAbsen->status == 'Hadir' ? 'success' : ($todayAbsen->status == 'Terlambat' ? 'warning' : 'secondary') }} badge-pill">
                                            {{ $todayAbsen->status }}
                                        </span>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="font-weight-bold text-gray-800">
                                            ...
                                            {{ $todayAbsen->jam_masuk ? substr($todayAbsen->jam_masuk, 0, 5) : '-' }}
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="font-weight-bold text-gray-800">
                                            ...
                                            {{ $todayAbsen->jam_keluar ? substr($todayAbsen->jam_keluar, 0, 5) : '-' }}
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                        ...
                        <tbody>
                            @forelse($absensi as $index => $item)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge badge-{{ $item->shift_id == 1 ? 'primary' : ($item->shift_id == 2 ? 'warning' : ($item->shift_id == 3 ? 'info' : 'secondary')) }}">
                                    ...
                                    @if(auth()->user()->role === 'HRD')
                                        <td class="text-center">
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('absensi.edit', $item->id) }}" class="btn btn-sm btn-info"
                                                    data-toggle="tooltip" title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <button onclick="deleteAbsensi({{ $item->id }})" class="btn btn-sm btn-danger"
